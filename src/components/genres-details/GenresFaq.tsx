...
const GenresFaq = () => {
    return (
        <>
            <section className="ms-faq-area pt-120 bd-accordion-fix">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            <div className="section__title-wrapper text-center mb-50">
                                <h2 className="section__title mb-35">Have questions? We have answers!</h2>
                    ...
                    <div className="ms-border2 pb-110">
                        <div className="row">
